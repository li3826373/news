...
<body>
  ...
  <div class="new-content ">
    <div class="news container">
      ...
      <?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="row" onclick="location.href='<?php echo U('NewsInfo/index',array('articleid'=>$vo['articleid']));?>'">
          <div class="news-img col-xs-4">
            <img src="/hzr/Uploads/<?php echo ($vo["imagename"]); ?>">
          </div>
          <div class="news-txt col-xs-8">
            <h5><?php echo ($vo["title"]); ?></h5>
            <p><?php echo (mb_substr(strip_tags(htmlspecialchars_decode($vo["describle"])),0,15,'UTF-8')); ?>..</p>
          </div>
  ...
  <script src="/hzr/Public/phone/js/news.js" charset="utf-8"></script>
