        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center">
                <form action="<?php echo U('Friend/add');?>" class="jqtransform" method="post" enctype="multipart/form-data">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                   
                 <tr>
                  <td class="td_right">名称：</td>
                  <td class=""> 
                    <input type="text" name="title" class="input-text lh30 username" size="40" onfocus="this.value=''">
                  </td>
                </tr>
                  ...
                  <td class=""> 
                    <input type="text" name="link" class="input-text lh30 password" size="40" onfocus="this.value=''">
                  </td>
                </tr>
                  ...
                  <td class=""> 
                    <input type="file" name="imagename" class="input-text lh30 password" size="40">
                  </td>
                </tr>
