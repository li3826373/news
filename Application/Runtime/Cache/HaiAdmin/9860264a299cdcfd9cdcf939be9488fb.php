        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center">
                <form action="<?php echo U('News/addtype');?>" class="jqtransform" method="post" enctype="multipart/form-data">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td class=""> 
                    <input type="radio" value="1" name="state">显示在导航菜单 <input type="radio" value="2" name="state">不显示在导航菜单
                  </td>
                  ...
                  <td class=""> 
                      <select name="fid" class="select"> 
                          ...
                          <?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if(($v["id"]) == $info["id"]): ?>selected<?php endif; ?>><?php echo ($v["typename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                  </td>
